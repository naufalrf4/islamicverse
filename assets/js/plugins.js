...
(function (d, f, g, b) {
  if (!d) {
    console.error(
      "jQuery não encontrado, seu plugin jQuery não irá funcionar."
    );
    return false;
  }
  (function () {
        ...
        a.hasClass("navbar-full")
          ? (n("nav.navbar.bootsnav")
            ...
            n("ul.nav.navbar-nav").prepend(
              "<li class='close-full-menu'><a href='#'><i class='fa mdi-close'></i></a></li>"
            ))
              ...
              n("a.dropdown-toggle", this).on("click", function (a) {
                a.stopPropagation(),
                  ...
                  n(".navbar-toggle").each(function () {
                    n(".mdi", this).removeClass("mdi-close"),
                      n(".mdi", this).addClass("mdi-menu"),
          ...
          n(".navbar-toggle").each(function () {
            n(this).off("click"),
              n(this).on("click", function () {
                n(".mdi", this).toggleClass("mdi-menu"),
                  n(".mdi", this).toggleClass("mdi-close"),
                  i();
              });
          });
      } else
